...
SECRET_KEY = "django-insecure-o!(ol0z&wr-a4=!dhupmdik0b7#+)%v68(=%+pa&b_8%p^4l2d"
...
MIDDLEWARE = [
    "corshears.middleware.CorsMiddlewaredjango.middleware.security.SecurityMiddleware",
...
WSGI_APPLICATION = "openit.wsgi.application"
